<div class="alert alert-light text-center" role="alert">
 ...
 <h2 class="trnding-tps">Expeditions</h2>
</div>
  <div class="container" >
  <div class="row">
    <div class="col-12 col-sm-6 col-md-4 col-lg-3 ">
      <div class="card border-0" data-aos="fade-up" data-aos-duration="1200">
        ...
        <img class="card-img-top" src="{{ asset('img/k222.jpg') }}" alt="K2">
          ...
          <a href="{{ url('expeditions/k2') }}" class="button">
            More Detail
            <!-- <button type="button" class="btn btn-secondary btn-lg btn-block " id=
              "card-button" >More Detail</button> -->
          </a>
        </div>
      </div>
    </div>
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card border-0" data-aos="fade-up" data-aos-duration="1200">
        ...
        <img class="card-img-top" src="{{ asset('img/gasherbrum3.jpg') }}" alt="K2">
          ...
          <a href="{{ url('expeditions/broadp') }}" class="button">
            More Detail
            <!-- <button type="button" class="btn btn-secondary btn-lg btn-block " id=
              "card-button">More Detail</button> -->
          </a>
...
<div class="alert alert-light text-center" role="alert">
 <!--  A simple info alert with <a href="#" class="alert-link">an example link</a>. Give it a click if you like. -->
 <h2 class="trnding-tps">Trek  & Tours</h2>
</div>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card border-0 " data-aos="fade-up" data-aos-duration="1200">
        <div class="card-body text-center">
          ...
          <a href="{{ url('treks/patundas') }}" class="button">
            More Detail
            <!-- <button type="button" class="btn btn-secondary btn-lg btn-block" id=
          "card-button">More Detail</button> -->
        </a>
 ...
 <div class="alert alert-light text-center" role="alert">
 <!--  A simple info alert with <a href="#" class="alert-link">an example link</a>. Give it a click if you like. -->
 <h2 class="trnding-tps">CULTURAL TOURS</h2>
</div>
 <div class="row">
  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card border-0" data-aos="fade-up" data-aos-duration="1200">
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card border-0" data-aos="fade-up" data-aos-duration="1200">
        <div class="card-body text-center">
          ...
          <a href="{{ url('cultural/lahore') }}" class="button">
            More Detaiil
            <!-- <button type="button" class="btn btn-secondary btn-lg btn-block " id=
              "card-button">More Detail</button> -->
          </a>
  ...
  <div class="alert alert-light text-center" role="alert">
 <!--  A simple info alert with <a href="#" class="alert-link">an example link</a>. Give it a click if you like. -->
 <h2 class="trnding-tps">SAFARI TOURS</h2>
</div>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3 ">
      <div class="card border-0" data-aos="fade-up" data-aos-duration="1200">
        <div class="card-body text-center">
          ...
          <a href="{{ url('services/heli') }}" class="button">
            More Detail
            <!-- <button type="button" class="btn btn-secondary btn-lg btn-block " id=
              "card-button" >More Detail</button> -->
          </a>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card border-0" data-aos="fade-up" data-aos-duration="1200">
        <div class="card-body text-center">
          ...
          <a href="{{ url('safari/balochistan') }}" class="button">
            More Detaiil
            <!-- <button type="button" class="btn btn-secondary btn-lg btn-block " id=
              "card-button">More Detail</button> -->
          </a>
    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
      <div class="card border-0" data-aos="fade-up" data-aos-duration="1200">
        ...
        <img class="card-img-top" src="{{ asset('img/skd-fall.jpg') }}" alt="K2">
          ...
          <a href="{{ url('safari/sarfaranga') }}" class="button">
            More Detail
         <!--  <button type="button" class="btn btn-secondary btn-lg btn-block " id=
          "card-button">More Detail</button> -->
        </a>
...
<div class="container">
  <div class="row">
    <div class="col text-center">
      <!-- <button class="btn btn-info" data-aos="fade-up" data-aos-duration="2000">View All Trek & Tours</button> -->
    </div>
  </div>
</div>
<br><br>